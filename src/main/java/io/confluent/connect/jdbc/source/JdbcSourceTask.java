    ...
    public void start(Map<String, String> properties) {
        ...
        for (String tableOrQuery : tablesOrQuery) {
            ...
            if (mode.equals(JdbcSourceTaskConfig.MODE_BULK)) {
                ...
                tableQueue.add(new CustomTimestampIncrementingTableQuerier(config, queryMode, tableOrQuery, null, incrementingColumn, offset));
            } else if (mode.equals(JdbcSourceTaskConfig.MODE_TIMESTAMP)) {
                tableQueue.add(new CustomTimestampIncrementingTableQuerier(config, queryMode, tableOrQuery, timestampColumn, null, offset));
            } else if (mode.endsWith(JdbcSourceTaskConfig.MODE_TIMESTAMP_INCREMENTING)) {
                tableQueue.add(new CustomTimestampIncrementingTableQuerier(config, queryMode, tableOrQuery, timestampColumn, incrementingColumn, offset));
            }
        }
